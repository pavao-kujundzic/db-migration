...
@EnableJpaRepositories(basePackages = {
		"hr.sedamit.bss.databasemigrations.batch.repository" }, entityManagerFactoryRef = "batchEntityManagerFactory", transactionManagerRef = "batchTransactionManager")
public class BatchDatabaseConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean batchEntityManagerFactory(
			@Qualifier("batchDataSource") DataSource postgreDataSource) {
